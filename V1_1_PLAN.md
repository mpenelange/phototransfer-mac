# Photo Transfer 1.1 plan

Version 1.1 expands the safe transfer core toward the most useful parts of Nikon Transfer 2 while keeping a focused, native macOS workflow.
...
Direct imports from cameras that expose only PTP/Image Capture interfaces are intentionally deferred until the mounted-volume workflow and its safety guarantees are complete.
